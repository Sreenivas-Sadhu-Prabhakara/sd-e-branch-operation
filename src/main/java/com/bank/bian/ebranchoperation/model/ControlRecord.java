package com.bank.bian.ebranchoperation.model;
...
/**
 * The BIAN control record for this service domain: "Digital Branch Session Operating Session".
 *
 ...
 * to its asset type (Digital Branch Session). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Digital Branch Session Operating Session";
